    ...
    <div class="container">
      <div class="section">
        <div class="column is-6 is-offset-3">
          <center>
            <h1 class="title" style="padding-top: 20px">Odogwu Fest Installation</h1><br>
          </center>
          <div class="box">
            <?php
switch ($step) {
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright by Odogwufest.</p><br>
  </div>
</body>
