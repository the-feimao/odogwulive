<html lang="en"><head>
    ...
    <p class="lead">
        <strong class="block" >Thanks for purchase Odogwu fest </strong>
        <br>
    ...
    <hr>
    <p class="lead">
    <a class="btn btn-primary btn-sm" href="{{url('/installer/install')}}" role="button">Odogwu fest Installer</a>
    </p>
    </div>
